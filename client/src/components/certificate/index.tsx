        ...
        <div className="w-full h-full flex items-center justify-start bg-[#FFFFFF] border-1 border-[#D1D5DC] flex flex-col p-[1px]">
          ...
          <div className="w-full flex flex-col items-center justify-center p-[8px]">
            <div
              ...
              style={{ fontWeight: "700", fontSize: "14px", color: "#4A5565" }}
            >
            ...
            <div
              className={segoeUI.className}
              style={{ fontWeight: "400", fontSize: "8px", color: "#4A5565" }}
            >
            ...
            <div className="w-full mt-4 flex items-center justify-center flex-col gap-2">
              ...
              <div className="flex items-center justify-center text-center w-3/4">
                ...
                >
                  ...
                  <span className="font-bold" style={{ color: levelColor() }}>
                    Nivel {props.level.toUpperCase()}
                  </span>{" "}
                  em responsabilidade social empresarial, demonstrando
                  compromisso genuíno com o impacto social e desenvolvimento
                  sustentável da cidade do Recife.
                </div>
              </div>
                ...
                <div className="w-full h-[81px] flex flex-row items-center justify-between gap-6 p-8">
                  <div className="flex flex-col items-center justify-center w-1/3 ">
                    <Image
                      ...
                      width={41}
                      height={15}
                      className="w-[41px] h-[15px] mb-1"
                    />
                    <Signature
                      orgao="Portal Bora Impactar"
                      cargo="Coordenacao Tecnica"
                    />
                  </div>
                  <div className="flex flex-col items-center justify-center w-1/3">
                    <Image
                    ...
                    <Signature
                      ...
                      cargo="Secretário de Desenvolvimento Social"
                    />
                  </div>
                  <div className="flex flex-col items-center justify-center w-1/3">
                    <Image
              ...
              <div className="w-full static flex flex-row items-center justify-between rounded-[4px] bg-[#f9fafb] border-1 border-[#D1D5DC] p-1 h-1/4 mb-1">
                <div className="w-4/5 flex flex-col items-start justify-center text-center ml-2">
                  ...
                  >
                    Certificado pode ser verificado em:{" "}
                    <a
                      href="https://portal.boraimpactar.recife.pe.gov.br/verificar"
                      style={{ color: "#4A5565", fontFamily: "monospace" }}
                    >
                      portal.boraimpactar.recife.pe.gov.br/verificar
                    </a>
                  </div>
                  <div
                    className={segoeUI.className}
                  ...
                  >
                    Este documento possui validade digital e reconhecimento
                    oficial da Prefeitura do Recife • Emitido conforme Lei
                    Municipal de Responsabilidade Social Empresarial
                  </div>
                </div>
